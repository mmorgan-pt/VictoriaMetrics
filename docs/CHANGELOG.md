...
* BUGFIX: [vmctl](https://docs.victoriametrics.com/vmctl.html): introduce step intervals for the explore metrics process. It should reduce the resource usage for requests with long date ranges. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/5369).  
